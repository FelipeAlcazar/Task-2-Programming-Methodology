...
/**
 * <P><P>This class represents an interface for the binary Tree ADT.
...
public interface BinTreeInterface<T> {
  ...
  /**
   * Adds a node containing element e2 as left child of the node containing
   * element e1. The tree must contain a node with e1 before using this method.
   * e2 must not exist in any node of the tree.
   * @param e1  The element used a key to find the parent node
   * @param e2  The element used a key for the left child node
  ...
  /**
   * Adds node n2 as left child of the node n1. The tree must contain n1 before
   * using this method. n2 must not exist in the tree.
   * @param n1  The parent node
   * @param n2  The left child node
  ...
  /**
   * Adds node n2 as right child of the node n1. The tree must contain n1 before
   * using this method. n2 must not exist in the tree.
   * @param n1  The parent node
   * @param n2  The right child node
   * @throws ProblemInTreeException if node n2 is already in the tree or node n1
	 *         does not exist
   */
   ...
   * the element
   */
  public NodeBinTree<T> getNode(T e);
  ...
  /**
   * This method returns the left node of the node containing element e
   * @return The left node of the node containing element e
   */
  public NodeBinTree<T> getLeft(T e);

  /**
   * This method returns the left node of node n
   * @return The left node of node n
   */
  public NodeBinTree<T> getLeft(NodeBinTree<T> n);

  /**
   * This method returns the right node of the node containing element e
   * @return The right node of the node containing element e
   */
  public NodeBinTree<T> getRight(T e);

  /**
   * This method returns the right node of node n
   * @return The right node of node n
   */
